...
use Proxy\MysqlPacket\ErrorPacket;
use Proxy\MysqlPacket\HandshakePacket;
use Proxy\MysqlPacket\MySQLMessage;
use Proxy\MysqlPacket\OkPacket;
use Proxy\MysqlPacket\Util\Capabilities;
use Proxy\MysqlPacket\Util\CharsetUtil;
use Proxy\MysqlPacket\Util\SecurityUtil;
...
{
    private bool|int $isDuplex;
    public \swoole_server $server;
    public int $serverFd;
    public $charset;
    public $account;
    public $auth = false;
