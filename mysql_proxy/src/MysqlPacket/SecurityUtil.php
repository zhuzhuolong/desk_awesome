...
class SecurityUtil
{
    public static function scramble411(string $pass, array $seed): array
    {
    ...
    public static function scrambleSha256(string $pass, array $seed): array
    {
    ...
    private static function xorPassword($password, $salt): string
    {
